...
{
    public class FileUpload1Controller : Controller
    {
        private readonly IFileUpload _fileupload;
        public FileUpload1Controller(IFileUpload fileUpload)
        {
        ...
        {
            TempData.Remove("FileData1");
           
            string FormCode = Convert.ToString(TempData.Peek("FormCode1"));
            int TransactionId = Convert.ToInt32(TempData.Peek("FileRefId1"));
        ...
        public async Task<IActionResult> StoreFileKeys(string filedata)
        {
            ...
            try
            {
                ...
                HttpContext.Session.SetComplexData("FileData1", serializeData);////As per Rajveer Told Set Data to Session
                res = "1";
            }
            catch (Exception ex)
            {
